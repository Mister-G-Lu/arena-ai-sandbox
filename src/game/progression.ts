...
export const ZONES: ZoneDef[] = [
  ...
  {
    id: 'records-basement',
    title: 'The Records Basement',
    kicker: 'EXPEDITION // ARC II',
    blurb: 'The municipal ledgers are stored below the city. The addresses are not records of places; they are instructions for keeping places here.',
    board: 'investigations',
    entry: 'records-basement-01',
    visibleRequires: { day: 31 },
    requiresUnlock: 'restricted-areas',
    requires: { day: 31, doubt: 4, perception: 3 },
    component: 'lens',
    componentLabel: 'LENS',
    onceEach: true,
    lockedNote: 'The basement is listed in a handwriting the roster does not recognise. Bring a torch, and enough doubt to read what the ledgers mean.',
    closedNote: 'The basement has been filed under a street that no longer exists. The LENS remains legible.',
  },
  {
    id: 'vent-network',
    title: 'The Vent Network',
    kicker: 'EXPEDITION // ARC II',
    blurb: 'Between the rendered walls is a maintenance route wide enough for a person and old enough to remember Operator 5.',
    board: 'investigations',
    entry: 'vent-network-01',
    visibleRequires: { day: 31 },
    requiresUnlock: 'self-dispatch',
    requires: { day: 31, perception: 4 },
    component: 'wire',
    componentLabel: 'WIRE',
    onceEach: true,
    lockedNote: 'Lead Operators may request the maintenance map. The map recommends bolt cutters and discourages remembering the way back.',
    closedNote: 'The vents have been sealed behind a wall that was not there. The WIRE still bridges what it should not.',
  },
  {
    id: 'rooftop-array',
    title: 'The Rooftop Array',
    kicker: 'EXPEDITION // ARC II',
    blurb: 'Above the weather loop, the antennas point at a sky the city insists is empty. One of them is receiving.',
    board: 'investigations',
    entry: 'rooftop-array-01',
    visibleRequires: { day: 31 },
    requiresUnlock: 'self-dispatch',
    requires: { day: 31, doubt: 5 },
    component: 'crystal',
    componentLabel: 'CRYSTAL',
    onceEach: true,
    lockedNote: 'The roof requires a radio permit, a warm thermos, and the patience to hear a signal beneath the city\'s test tone.',
    closedNote: 'The antennas have been turned toward a safer sky. The CRYSTAL remembers the carrier.',
  },
  {
    id: 'off-map-sectors',
    title: 'The Off-Map Sectors',
    kicker: 'EXPEDITION // ARC II',
    blurb: 'VANTABLACK will take you past Sector 9, where the road becomes a wireframe and the dispatch console stops pretending.',
    board: 'investigations',
    entry: 'off-map-sectors-01',
    visibleRequires: { day: 31 },
    requiresUnlock: 'classified-memos',
    requires: { day: 31, doubt: 5, perception: 4 },
    component: 'chip',
    componentLabel: 'CHIP',
    onceEach: true,
    lockedNote: 'Acting Manager clearance is required for a route that leaves the municipal map. VANTABLACK\'s callsign must be on file.',
    closedNote: 'Sector 10 has been removed from the route table. The CHIP contains the copy of you that made it there.',
  },
  {
    id: 'interim-deep',
    title: 'The Interim Deep',
    kicker: 'EXPEDITION // ARC II / INTERIM',
    blurb: 'There is a frame between termination and the next shift. Someone has left a door open in it, and the Auditor is waiting on the other side.',
    board: 'investigations',
    entry: 'interim-deep-01',
    visibleRequires: { day: 31 },
    requiresUnlock: 'classified-memos',
    requires: { day: 31, components: 5, deaths: 1 },
    component: 'interim',
    componentLabel: 'INTERIM',
    onceEach: true,
    lockedNote: 'The sixth component is not found during a normal shift. The Interim opens only after a chosen death and five components.',
    closedNote: 'The Interim has closed around the gap. The sixth component is cold, bright, and yours.',
  },
];
